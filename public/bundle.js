...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__source_application__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__views_rootContainer_view__ = __webpack_require__(8);
...
$(()=>{
  let app = __WEBPACK_IMPORTED_MODULE_0_backbone_marionette___default.a.Application({
    region: '#root',
    onStart(){
      this.showView(new __WEBPACK_IMPORTED_MODULE_1__views_rootContainer_view__["a" /* default */]());
    },
    initialize(){
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_backbone_marionette__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_backbone_marionette___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_backbone_marionette__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__profileContainer_view__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__profileDetailContainer_view__ = __webpack_require__(10);




let rootContainer = __WEBPACK_IMPORTED_MODULE_0_backbone_marionette___default.a.View.extend({
  template: "<div></div>",
  regions: {
  ...
  onRender() {
    this.showChildView("profileContainer", new __WEBPACK_IMPORTED_MODULE_1__profileContainer_view__["a" /* default */]())
    this.showChildView("profileDetailContainer", new __WEBPACK_IMPORTED_MODULE_2__profileDetailContainer_view__["a" /* default */]())
  }
})
...
let profileContainer = __WEBPACK_IMPORTED_MODULE_0_backbone_marionette___default.a.View.extend({
  template: __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.template(`
...
let profileDetailsContainer = __WEBPACK_IMPORTED_MODULE_0_backbone_marionette___default.a.View.extend({
  template: __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.template(`
    <div id='profileDetailsContainer'></div>
  `)
});
/* harmony default export */ __webpack_exports__["a"] = (profileDetailsContainer);
